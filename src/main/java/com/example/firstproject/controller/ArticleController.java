...
public class ArticleController {
    @Autowired // 스프링 부트가 미리 생성해 놓은 리파지터리 객체 주입(DI) => 의존성 주입  스프링부트에서 제공하는 어노테이션사용
    ...
    public  String show(@PathVariable Long id, Model model){ // Url 주소에 들어온 값을 id변수로 매핑시킴
        
        //Article 의 식별자 값 가져오기
        log.info("id = "+id);
        // 1. id를 조회해 데이터 가져오기
